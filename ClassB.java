...
import mypack.*;
//import is make class and interface available ad we are importing
//the behavior of mypack
import mypack.ClassA;//or it giving access to .classfile in this package
...
public class ClassB {
	...
	//String[] args is actually an array of java.lang.String type and it's name is args here
		...
		demo.bark();//here displaying the properties
		demo.run();//here displaying the properties
	}
